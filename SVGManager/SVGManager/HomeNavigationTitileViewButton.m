...
- (UILabel *)titleLabel{
    if (!_titleLabel) {
        ...
        _titleLabel.textColor = [UIColor colorWithHexString:@"0x756a69"];
    }
    return _titleLabel;
}
...
- (void)hidTitleLine{
    if (self.isSelected) {
        ...
        self.titleLabel.textColor = [UIColor colorWithHexString:@"0x389dc2"];
    } else {
        self.titleLine.hidden = YES;
        self.titleLabel.textColor = [UIColor colorWithHexString:@"0x756a69"];
    }
}
