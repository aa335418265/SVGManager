...
- (void)loadNewJokes {
    ...
    NSString *path = [NSString stringWithFormat:@"/joke/randJoke.php?key=2090f75b96a8333becd2811aaf427295"];
    ...
    [op addCompletionHandler:^(MKNetworkOperation *completedOperation) {
        ...
        NSArray *models = [[JokesModel mj_objectArrayWithKeyValuesArray:result context:nil] mutableCopy];
        if (models.count >0) {
